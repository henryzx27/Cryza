...
import { FaTwitter, FaGithub, FaLinkedin, FaEnvelope, FaPhoneAlt } from "react-icons/fa";

export default function Footer() {
  return (
    <footer className="relative w-full bg-gradient-to-b from-[#050510] via-[#0a0f1f] to-black text-white px-6 pt-20 pb-10 border-t border-white/10">
      {/* Glow Accent */}
      <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-cyan-400 to-purple-500"></div>

      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
        {/* Brand */}
        <div className="md:col-span-2">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-gradient-to-br from-cyan-500 to-blue-800 rounded-full flex items-center justify-center shadow-xl">
          ...
          <p className="text-white/60 text-sm leading-relaxed max-w-md mb-4">
            Cryza is a digital design & tech studio crafting beautiful, fast, and scalable online experiences.
          </p>
        ...
        {/* Services */}
        <div>
          <h4 className="text-cyan-400 text-sm font-semibold mb-4 uppercase tracking-wider">What We Do</h4>
        ...
        {/* Social */}
        <div>
          <h4 className="text-cyan-400 text-sm font-semibold mb-4 uppercase tracking-wider">Connect</h4>
